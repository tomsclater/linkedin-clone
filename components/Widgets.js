...
function Widgets({ articles }) {
  ...
  <div classNAme="hidden xl:inline space-y-2">
      ...
      <div className="bg-white dark:bg-[#1d2226] py-2.5 rounded-lg space-y-2 w-11/12 overflow-hidden border border-gray-300 dark:border-none">
        <div className="flex items-center justify-between font-bold p-x-2.5">
            <h4>LinkedIn News</h4>
      ...
      {/* {Ads} */}
      <div className="bg-white dark:bg-[#1D2226] w-11/12 h-64 px-2.5 mt-2 rounded-lg sticky top-20 border border-gray-300 dark:border-none">
